...
public class Lesson02Test {
    ...
    Поля:
    Name:               Test group551003.olenev (тут ваша фамилия)
    Test kind:          All in package
    Package:            by.it.group551003.olenev.lesson02 (тут ваша фамилия)
    ...
    */
    ...
    public void checkC_greedyKnapsack() throws Exception {
        ...
        boolean ok = Math.abs(costFinal - 200) < 0.0001; // Используем допуск для double
